...
This verifies that the two VLANs are logically isolated.
...
* `VLAN.pkt` — Cisco Packet Tracer VLAN lab
* `screenshots/` — Lab configuration and verification screenshots
